...
#Ho hashato le password spero non sia un problema perché ho letto che non conviene scrivere 
#le password direttamente nel codice, ad ogni modo le password sono commentate e le diremo poi 
#agli ammisistratori

#ADMIN_PWD = eqvU148VnKHornxdmaUX08ElRsj6tDkVMqpUksf4qdM
ADMIN_PWD_HASH = os.getenv(
    "ADMIN_PWD_HASH",
    "$argon2id$v=19$m=65536,t=3,p=4$3YLcLxejnPoymtdfStwhcw$G6ml8UbGpGmkfm+loC0YadcMEtt/lZOFkD8ufvP7JYU",
)

#IMAGE_PWD = ZaE86wpZMl8lAjpMI7yezFaSNIUv4yS84LzWoEOdcPI
IMAGE_PWD_HASH = os.getenv(
    "IMAGE_PWD_HASH",
    "$argon2id$v=19$m=65536,t=3,p=4$SB9Ank4SKvDk1rw9zbiSlA$6HrOLfeJ32XuOPGHzDwsOJcTtJrBC6/UEymIlfGPZRI",
)
